...
export default function Projects() {
  return (
    <section id="projects" className="p-10 bg-base-200">
        <div className="min-h-screen text-center md:px-10">
          ...
          <h1 className="text-4xl md:text-5xl mb-15 font-bold transition-all duration-300 hover:text-info animate-fade-in-down delay-200">
            My Projects
          </h1>
          
          <div className="flex flex-col md:mx-15 gap-15">
